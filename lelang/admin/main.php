        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="temp/dist/img/user8-128x128.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=$_SESSION['nama']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="temp/dist/img/user8-128x128.jpg" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="../config/logout.php" class="btn btn-default btn-flat">Log out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class=" merah small-box bg-orange">
            <div class="inner">
              <h3><?=$lelang?></h3>     
