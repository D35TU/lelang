...
if( $page == 'barang'){
  ...
  <div class="site-section">
          <div class="container">
            <?php 
            $mtr = mysqli_query($koneksi,"SELECT * FROM barang WHERE kategori = '---'");
            $mbl = mysqli_query($koneksi,"SELECT * FROM barang WHERE kategori = '---'");
                  ...
                  <div class="col-6 col-md-4 col-lg-4">
                    <div class="item">
                      ...
                      <div class="p-4">
                        ...
                        <a href="main.php?page=item&&id=<?=$data['id']?>" class="btn  btn-primary">Masukkan Penawaran Anda</a>
                      </div>
    ...
    <div class="site-section">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5">
              <h2 class="mb-5 text-black"><strong>Log In - Account</strong></h2>
            ...
            <div class="col-lg-5">
              <h2 class="mb-5 text-black"><strong>Registrasi - Account</strong></h2>
              ...
              <div class="side-box mb-4">
                ...
                <form action="bid.php" method="post">
                  <div class="mb-4">
                    ...
                    <input type="text" name="email_kandidat" class="form-control mb-2" placeholder="Input EMAIL Anda" required> 
